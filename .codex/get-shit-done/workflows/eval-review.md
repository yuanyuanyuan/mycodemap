...
```bash
AUDITOR_MODEL=$(node "/data/codemap/.codex/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /data/codemap/.codex/agents/gsd-eval-auditor.md for instructions.
