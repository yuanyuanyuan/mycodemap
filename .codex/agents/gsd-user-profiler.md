...
<reference>
@/data/codemap/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/data/codemap/.codex/get-shit-done/references/user-profiling.md` to load:
