...
<execution_context>
@/data/codemap/.codex/get-shit-done/workflows/insert-phase.md
</execution_context>
...
<process>
Execute the insert-phase workflow from @/data/codemap/.codex/get-shit-done/workflows/insert-phase.md end-to-end.
