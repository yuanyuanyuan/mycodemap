...
Intel system is disabled. To activate:
  ...
  node /data/codemap/.codex/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /data/codemap/.codex/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /data/codemap/.codex/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /data/codemap/.codex/get-shit-done/bin/gsd-tools.cjs intel diff
```
