...
<execution_context>
@/data/codemap/.codex/get-shit-done/workflows/progress.md
</execution_context>

<process>
Execute the progress workflow from @/data/codemap/.codex/get-shit-done/workflows/progress.md end-to-end.
