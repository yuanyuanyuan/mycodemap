...
<execution_context>
@/data/codemap/.codex/get-shit-done/workflows/remove-phase.md
</execution_context>
...
<process>
Execute the remove-phase workflow from @/data/codemap/.codex/get-shit-done/workflows/remove-phase.md end-to-end.
