...
<execution_context>
@/data/codemap/.codex/get-shit-done/workflows/audit-fix.md
</execution_context>

<process>
Execute the audit-fix workflow from @/data/codemap/.codex/get-shit-done/workflows/audit-fix.md end-to-end.
</process>
