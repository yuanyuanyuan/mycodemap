...
<execution_context>
@/data/codemap/.codex/get-shit-done/workflows/verify-work.md
...
<process>
Execute the verify-work workflow from @/data/codemap/.codex/get-shit-done/workflows/verify-work.md end-to-end.
