...
<execution_context>
@/data/codemap/.codex/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/data/codemap/.codex/get-shit-done/workflows/forensics.md end-to-end.
</process>
