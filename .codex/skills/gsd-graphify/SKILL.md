...
Knowledge graph is disabled. To activate:
  ...
  node /data/codemap/.codex/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /data/codemap/.codex/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /data/codemap/.codex/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/data/codemap/.codex/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /data/codemap/.codex/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"/data/codemap/.codex/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
