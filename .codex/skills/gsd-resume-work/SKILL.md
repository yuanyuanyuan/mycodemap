...
<execution_context>
@/data/codemap/.codex/get-shit-done/workflows/resume-project.md
</execution_context>

<process>
**Follow the resume-project workflow** from `@/data/codemap/.codex/get-shit-done/workflows/resume-project.md`.
