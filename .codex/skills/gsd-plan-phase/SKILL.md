...
<execution_context>
@/data/codemap/.codex/get-shit-done/workflows/plan-phase.md
...
<process>
Execute the plan-phase workflow from @/data/codemap/.codex/get-shit-done/workflows/plan-phase.md end-to-end.
