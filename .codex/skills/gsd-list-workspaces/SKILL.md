...
<execution_context>
@/data/codemap/.codex/get-shit-done/workflows/list-workspaces.md
@/data/codemap/.codex/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @/data/codemap/.codex/get-shit-done/workflows/list-workspaces.md end-to-end.
</process>
