...
<required_reading>
@/data/codemap/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /data/codemap/.claude
                  → checks /data/codemap/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /data/codemap/.claude/get-shit-done
                  → writes to /data/codemap/.claude/get-shit-done/hooks/
...
@/data/codemap/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/data/codemap/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/data/codemap/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/data/codemap/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/data/codemap/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
