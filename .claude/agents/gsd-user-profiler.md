...
<reference>
@/data/codemap/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/data/codemap/.claude/get-shit-done/references/user-profiling.md` to load:
