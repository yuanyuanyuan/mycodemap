...
Use template from `/data/codemap/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/data/codemap/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/data/codemap/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
