...
@/data/codemap/.claude/get-shit-done/references/mandatory-initial-read.md
...
**Project skills:** @/data/codemap/.claude/get-shit-done/references/project-skills-discovery.md
...
@/data/codemap/.claude/get-shit-done/references/planner-source-audit.md for full format, examples, and gap-handling rules.
...
@/data/codemap/.claude/get-shit-done/references/planner-source-audit.md for constraint examples.
