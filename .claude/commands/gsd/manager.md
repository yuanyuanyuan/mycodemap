...
<execution_context>
@/data/codemap/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/data/codemap/.claude/get-shit-done/workflows/manager.md end-to-end.
