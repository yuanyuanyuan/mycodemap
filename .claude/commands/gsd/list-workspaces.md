...
<execution_context>
@/data/codemap/.claude/get-shit-done/workflows/list-workspaces.md
@/data/codemap/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @/data/codemap/.claude/get-shit-done/workflows/list-workspaces.md end-to-end.
</process>
