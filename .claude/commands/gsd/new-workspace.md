...
<execution_context>
@/data/codemap/.claude/get-shit-done/workflows/new-workspace.md
@/data/codemap/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @/data/codemap/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
