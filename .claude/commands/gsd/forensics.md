...
<execution_context>
@/data/codemap/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/data/codemap/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
