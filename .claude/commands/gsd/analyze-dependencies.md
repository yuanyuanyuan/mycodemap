...
<execution_context>
@/data/codemap/.claude/get-shit-done/workflows/analyze-dependencies.md
</execution_context>
...
<process>
Execute the analyze-dependencies workflow from @/data/codemap/.claude/get-shit-done/workflows/analyze-dependencies.md end-to-end.
