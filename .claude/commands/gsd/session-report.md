...
<execution_context>
@/data/codemap/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/data/codemap/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
