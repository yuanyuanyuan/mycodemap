...
<execution_context>
@/data/codemap/.claude/get-shit-done/workflows/spec-phase.md
@/data/codemap/.claude/get-shit-done/templates/spec.md
</execution_context>
...
<process>
Execute the spec-phase workflow from @/data/codemap/.claude/get-shit-done/workflows/spec-phase.md end-to-end.
