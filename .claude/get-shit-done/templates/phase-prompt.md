...
<!-- For checkpoint task examples and patterns, see @/data/codemap/.claude/get-shit-done/references/checkpoints.md -->
...
See `/data/codemap/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/data/codemap/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/data/codemap/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
