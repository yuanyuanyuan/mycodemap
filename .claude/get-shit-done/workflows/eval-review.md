...
```bash
AUDITOR_MODEL=$(node "/data/codemap/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /data/codemap/.claude/agents/gsd-eval-auditor.md for instructions.
