...
Key references:
- @/data/codemap/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/data/codemap/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/data/codemap/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
✓ Stores profile at /data/codemap/.claude/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
SCAN_RESULT=$(node /data/codemap/.claude/get-shit-done/bin/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node /data/codemap/.claude/get-shit-done/bin/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `/data/codemap/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/data/codemap/.claude/get-shit-done/references/user-profiling.md
...
**Get questions:**
```bash
QUESTIONS=$(node /data/codemap/.claude/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANALYSIS_RESULT=$(node /data/codemap/.claude/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
node /data/codemap/.claude/get-shit-done/bin/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Profile written to /data/codemap/.claude/get-shit-done/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /data/codemap/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
```bash
node /data/codemap/.claude/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node /data/codemap/.claude/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to /data/codemap/.claude/CLAUDE.md"
...
Your profile:    /data/codemap/.claude/get-shit-done/USER-PROFILE.md
```
