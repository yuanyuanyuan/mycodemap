...
| 文档 | 模块 | 复杂度 |
|------|------|--------|
| REFACTOR_REQUIREMENTS.md | 需求与场景 | 高 |
| REFACTOR_ARCHITECTURE_OVERVIEW.md | 架构概览 | 高 |
| REFACTOR_ORCHESTRATOR_DESIGN.md | 编排层设计 | 极高 |
| REFACTOR_CONFIDENCE_DESIGN.md | 置信度机制 | 中 |
| REFACTOR_RESULT_FUSION_DESIGN.md | 结果融合 | 高 |
| REFACTOR_TEST_LINKER_DESIGN.md | 测试关联器 | 中 |
| REFACTOR_GIT_ANALYZER_DESIGN.md | Git 分析器 | 高 |
| CI_GATEWAY_DESIGN.md | CI 门禁 | 高 |
...
| REFACTOR_REQUIREMENTS.md | 需求与场景 |
