...
- [x] 63-01: Confidence contract, graph-optimized schema/projection, transactional storage foundation
- [x] 63-02: CLI/MCP compatibility lock, direct-execution regression coverage, real subprocess verification
...
- [x] 64-01: Changed-file detection, invalidation rules, scoped recompute engine, observability for reused vs recomputed graph slices
...
- [x] 65-01: Recursive traversal query, layered impact summary, CLI/MCP-readable result shaping, direct-vs-transitive verification
...
- [x] 66-01-PLAN.md — MCP-first community detection baseline, weighted projection, interpretable output, sparse-graph degradation proof
